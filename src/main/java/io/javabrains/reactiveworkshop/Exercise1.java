...
public class Exercise1 {
  ...
  public static void main(String[] args) {
    ...
    // TODO: Write code here
    StreamSources.intNumbersStream().filter(i -> i > 5).findFirst().ifPresentOrElse(System.out::println, () -> System.out.println(-1));
    ...
    StreamSources.intNumbersStream().flatMap(id -> StreamSources.userStream()
            .filter(user -> user.getId() == id)).map(user -> user.getFirstName())
        .forEach(System.out::println);
